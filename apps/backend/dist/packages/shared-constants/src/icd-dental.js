...
exports.ICD9_CATEGORIES = exports.ICD10_CATEGORIES = exports.ICD9_DENTAL = exports.ICD10_DENTAL = void 0;
exports.searchIcd10 = searchIcd10;
exports.searchIcd9 = searchIcd9;
exports.ICD10_DENTAL = [
...
function searchIcd10(query, limit = 30) {
    ...
    if (!q)
        return exports.ICD10_DENTAL.filter((i) => i.billable).slice(0, limit);
    return exports.ICD10_DENTAL
        .filter((i) => i.code.toLowerCase().includes(q) ||
        i.description.toLowerCase().includes(q) ||
        i.category.toLowerCase().includes(q))
        .slice(0, limit);
}
function searchIcd9(query, limit = 30) {
    const q = query.toLowerCase().trim();
    if (!q)
        return exports.ICD9_DENTAL.slice(0, limit);
    return exports.ICD9_DENTAL
        .filter((i) => i.code.toLowerCase().includes(q) ||
        i.description.toLowerCase().includes(q) ||
        i.category.toLowerCase().includes(q))
        .slice(0, limit);
}
exports.ICD10_CATEGORIES = [...new Set(exports.ICD10_DENTAL.map((i) => i.category))];
exports.ICD9_CATEGORIES = [...new Set(exports.ICD9_DENTAL.map((i) => i.category))];
//# sourceMappingURL=icd-dental.js.map