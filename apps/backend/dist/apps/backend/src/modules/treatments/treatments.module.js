...
exports.TreatmentsModule = TreatmentsModule = __decorate([
    (0, common_1.Module)({ controllers: [treatments_controller_1.TreatmentsController], providers: [treatments_service_1.TreatmentsService], exports: [treatments_service_1.TreatmentsService] })
], TreatmentsModule);
